...
- 📜 **34 built-in recipes** — traditionals, melomels, cysers, metheglins, bochets, braggots, sack & port-style meads, plus 5 **sparkling / bottle-conditioned** meads (champagne-style, cyser, session hydromel, berry, ginger), each with day-by-day step schedules, plus your own custom recipes and reusable templates
