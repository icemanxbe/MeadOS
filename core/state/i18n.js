...
var UI_PHRASES={
  ...
  'Show recent only':'Alleen recente tonen',
  ...
  'Priming sugar to bottle-condition a sparkling cider. The cider must be':'Primingsuiker om een mousserende cider op fles te rijpen. De cider moet',
  ...
  '— sorbate/sulfite stop the refermentation that makes the bubbles. Enter the highest temperature the cider has reached since fermentation; that sets how much CO₂ is already dissolved.':'— sorbaat/sulfiet stoppen de hergisting die de bubbels maakt. Vul de hoogste temperatuur in die de cider sinds de gisting bereikte; dat bepaalt hoeveel CO₂ er al opgelost is.',
  'Mead temp (°C)':'Medetemp (°C)','Cider temp (°C)':'Cidertemp (°C)','Priming sugar':'Primingsuiker','Corn sugar (dextrose)':'Maïssuiker (dextrose)',
  ...
  'Bottle-condition only a fully-fermented, un-stabilized cider in pressure-rated bottles (champagne/Belgian + crown caps or wired corks). Keep one PET tester bottle to feel the pressure. Condition 2–3 weeks at 18–22°C, then chill. See Cider Guide → Sparkling & Carbonated Cider.':'Rijp op fles alleen een volledig vergiste, niet-gestabiliseerde cider in drukbestendige flessen (champagne/Belgisch + kroonkurken of beugelkurken). Houd één PET-testfles om de druk te voelen. Rijp 2–3 weken bij 18–22°C, daarna koelen. Zie Cidergids → Mousserende & koolzuurhoudende cider.',
  'Only the':'Alleen de',
...
var UI_PATTERNS=[
  ...
  [/^Show all (\d+) readings$/, 'Alle $1 metingen tonen'],
  [/^Showing all (\d+) readings$/, 'Toont alle $1 metingen'],
  [/^Showing the latest (\d+) of (\d+)$/, 'Toont de laatste $1 van $2'],
